...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/06/04 14:22:18 by sbudilko          #+#    #+#             */
/*   Updated: 2018/06/04 14:22:21 by sbudilko         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/ft_printf.h"

int		ft_u_hh_2(int fd, t_syntax *syntax, int arg)
{
	int		len[2];
...
int		ft_u_hh(int fd, t_syntax *syntax, va_list *ap)
{
	...
	arg = va_arg(*ap, int);
	new_arg = (int)arg;
	len = ft_u_hh_2(fd, syntax, new_arg);
